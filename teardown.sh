...
print_header() {
    echo ""
    echo -e "${RED}╔═══════════════════════════════════════════════════════════════╗${NC}"
    echo -e "${RED}║${NC}              ${BOLD}AI Swarm v2 Teardown${NC}                              ${RED}║${NC}"
    echo -e "${RED}╚═══════════════════════════════════════════════════════════════╝${NC}"
    echo ""
}
...
teardown() {
    echo ""
    echo -e "${BOLD}Tearing down AI Swarm v2...${NC}"
    echo ""
    ...
    # FIX: Refactored individual volume removal into a loop for better maintainability
    local volumes=("ai_swarm_postgres" "ai_swarm_redis" "ai_swarm_worker_1_home" "ai_swarm_worker_2_home" "ai_swarm_worker_3_home" "ai_swarm_worker_4_home" "ai_swarm_portal_home")
