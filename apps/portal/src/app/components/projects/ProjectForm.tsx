...
export default function ProjectForm({ initialProject, initialDeployment, isEditing = false }: ProjectFormProps) {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        const data = {
            ...
            scmToken: formData.get('scmToken') || undefined,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="card space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-medium mb-1">Project Folder (Internal)</label>
                                <input
                                    type="text"
                                    name="projectFolder"
                                    required
                                    defaultValue={initialProject?.projectFolder || '/project'}
                                    className="input w-full"
                                />
                                <p className="text-[10px] text-muted-foreground mt-1">
                                    Path where code is cloned inside the worker (Host mount: <code className="text-[9px]">/home/ubuntu/apps</code>).
                                </p>
                            </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="card bg-swarm-surface/30 border-swarm-blue/20">
                        ...
                        <div className="text-sm text-muted-foreground space-y-3">
                            ...
                            <p>
                                <strong>2. Edit:</strong> The Coder agent edits source files in an isolated worktree within <code className="text-foreground text-[10px]">{initialProject?.projectFolder || '/project'}</code>.
                            </p>
                            <p>
                    ...
                    <div className="card bg-swarm-surface/30 border-yellow-500/20">
                        ...
                        <div className="text-xs text-muted-foreground space-y-2">
                            <p>
                                <strong>Worker Access:</strong> Internal mount point.<br />
                                <span className="font-mono text-foreground opacity-75 text-[10px]">/apps/my-app</span>
                            </p>
                            <p>
                                <strong>Worktree:</strong> Task-specific isolated folder.<br />
                                <span className="font-mono text-foreground opacity-75 text-[10px]">/apps/my-app/worktrees/task-1</span>
                            </p>
                            <p>
                                <strong>Target:</strong> Where the app is live.<br />
                                <span className="font-mono text-foreground opacity-75 text-[10px]">/home/ubuntu/apps/my-app</span>
                            </p>
                        </div>
                    </div>
                </div>
