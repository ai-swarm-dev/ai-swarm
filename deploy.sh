...
print_header() {
    echo ""
    echo -e "${BLUE}╔═══════════════════════════════════════════════════════════════╗${NC}"
    echo -e "${BLUE}║${NC}             ${BOLD}AI Swarm v2 Deployment${NC}                           ${BLUE}║${NC}"
    echo -e "${BLUE}╚═══════════════════════════════════════════════════════════════╝${NC}"
    echo ""
}
...
collect_configuration() {
    ...
    prompt_input "Allowed emails (comma-separated)" "" ALLOWED_EMAILS
    if [ -z "$ALLOWED_EMAILS" ]; then
        echo -e "  ${YELLOW}Warning: No email allowlist set. Any Google account can sign in.${NC}"
    fi
...
NEXT_PUBLIC_TEMPORAL_UI_URL=https://$TEMPORAL_DOMAIN
